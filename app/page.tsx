...
export default function HomePage() {
  return (
    <main>
      ...
      <footer className="print-hide bg-ink py-10 text-stone-300"><div className="mx-auto flex max-w-[1500px] flex-col gap-4 px-5 sm:flex-row sm:items-center sm:justify-between lg:px-8"><div><p className="font-serif text-xl font-bold text-white">InvoiceCraft</p><p className="mt-1 text-sm text-stone-400">Global documents for independent professionals.</p></div><p className="text-xs text-stone-500">No signup · No uploads · No hidden fees</p><a href="https://uptime-pulse-saas.vercel.app/?utm_source=freelance-invoice-generator&amp;utm_medium=referral&amp;utm_campaign=protected_by" target="_blank" rel="noopener noreferrer" className="text-xs text-stone-500 underline decoration-stone-700 underline-offset-4 transition hover:text-white">Protected by UptimePulse — Free Website &amp; SSL Monitor</a></div></footer>
